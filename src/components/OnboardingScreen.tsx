...
const OnboardingScreen: React.FC<OnboardingScreenProps> = ({ onComplete }) => {
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity
        onPress={skipToEnd}
        className="absolute top-16 right-6 px-4 py-2 rounded-full"
        style={{ 
          zIndex: 10,
      ...
      {/* Progress bar */}
      <View 
        className="absolute bottom-8 left-8 right-8 h-1 rounded-full overflow-hidden"
        style={{ backgroundColor: colors.isDark ? 'rgba(255,255,255,0.2)' : 'rgba(0,0,0,0.2)' }}
      >
        <View 
